...
| Mod | Version | Why |
|-----|---------|-----|
| [Voxy World Gen V2](https://modrinth.com/mod/voxy-worldgen) | `1.20+` | Background chunk pre-generation companion mod, required for best results. |
