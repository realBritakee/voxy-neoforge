...
| Type | Mod | Notes |
|------|-----|-------|
| **Required** | [Voxy World Gen V2](https://www.curseforge.com/minecraft/mc-mods/voxy-worldgen) | Background chunk pre-generation companion mod, required for best results. |
