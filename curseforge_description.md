...
A custom NeoForge port of Voxy - the high-performance Level of Detail (LoD) rendering mod for Minecraft.

Voxy renders distant terrain at reduced detail, allowing you to see hundreds of chunks further than normal render distance without the massive performance cost of rendering full geometry. Think Distant Horizons, but built specifically for performance and compatibility with modern rendering mods.

This fork maintains NeoForge compatibility across multiple Minecraft versions so you can enjoy massive vistas on your modpacks.
...
| Type | Mod | Notes |
|------|-----|-------|
| **Optional** | [Voxy World Gen V2](https://www.curseforge.com/minecraft/mc-mods/voxy-worldgen-v2) | Background chunk pre-generation companion mod, optional for best results. |
